    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == button){ // BUTTON FOR Mjolnir
        	try {
				...
				StaticSemaphore.nameOfWeaponChoosedByUser="Mjolnir";
        	...
        	try {
				StaticSemaphore.usedString.acquire();
				StaticSemaphore.mutex.acquire();
				StaticSemaphore.nameOfWeaponChoosedByUser="StormBreaker";
				StaticSemaphore.validString.release();
			} catch (InterruptedException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
        	...
        	try {
				StaticSemaphore.usedString.acquire();
				StaticSemaphore.mutex.acquire();
				StaticSemaphore.nameOfWeaponChoosedByUser="CapShield";
				StaticSemaphore.validString.release();
			} catch (InterruptedException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
            ...
            ChooseCharacter choose = new ChooseCharacter(name);
